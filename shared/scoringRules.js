...
export const rubric = [
  {
    ...
    items: [
      ...
      { id: "quality", title: "营销设计质量", max: 7, desc: "图文、短视频、文案等内容具有一定吸引力、传播力和转化导向，整体表达较专业。" },
    ],
  },
  {
    id: "ai",
    ...
    items: [
      ...
      { id: "rationality", title: "技术应用合理性", max: 10, desc: "AI 技术应用逻辑清晰，能够针对跨境电商业务中的实际问题提出解决方案。" },
    ],
  },
  {
    id: "result",
    ...
    items: [
      ...
      { id: "analysis", title: "优化分析能力", max: 10, desc: "能够基于实践过程识别业务痛点，提出针对性的 AI 优化思路与改进方案。" },
    ],
  },
  {
    id: "roadshow",
  ...
  },
  {
    ...
    accent: "rose",
    items: [
      { id: "reportQuality", title: "《AI 跨境电商应用实践报告》质量", max: 10, desc: "报告内容完整，能够系统呈现项目背景、实施过程、AI 应用路径、成果展示与优化建议。" },
    ],
  },
];
